...
fn test_new_diode_bundle() {
    ...
    assert_eq!(diode_bundle.triples(&[0.0, 0.0]).len(), 4);
    assert_eq!(diode_bundle.pairs(&[0.0, 0.0]).len(), 2);
...
fn test_pairs() {
    ...
    assert_eq!(diode_bundle.pairs(&[0.7, 0.0]).len(), 2);
}
...
fn test_pairs2() {
    ...
    assert_eq!(diode_bundle.pairs(&[0.7, 0.0]).len(), 1);
}
