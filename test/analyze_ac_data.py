#!/usr/bin/env python3
"""
Detailed analysis of AC RC cutoff frequency test
"""
...
def main():
    print("Detailed AC RC Cutoff Frequency Analysis")
    print("=" * 60)
    ...
    # Read data
    data = read_data('/tmp/ac_data.csv')
    
    # Print some data points
    print("Sample data points:")
    print("Freq (Hz)	|Vout/Vin|")
    print("-" * 30)
    for freq, v2_real, v2_imag in data[:20:4]:  # Every 4th point
        mag = calculate_magnitude(v2_real, v2_imag)
        print(f"{freq:8.1f}	{mag:.4f}")
    print()
